...
Using the [R package RNHANES](https://cran.r-project.org/web/packages/RNHANES/vignettes/introduction.html) to download the datasets. Downloaded datasets (original) saved in Sharepoint.
